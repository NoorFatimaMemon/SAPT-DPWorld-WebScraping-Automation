...
class Helper():
    def scraper(self, main_URL, Tracking_ID, headless):
        ...
        logging.info(f"Accessed -------------> {main_URL}")
        ...
        time.sleep(2)
        logging.info("--------------- Dialog Box Clicked ---------------")
        # To Click on Find your Container button
        logging.info("--------------- Clicking on Find your Container button ---------------")
        Container_Inquiry_button = driver.find_element(By.XPATH, '//h1[@class="day_time"]//span[text()= "Container"]')
        time.sleep(1)
        # Scroll to the Container_Inquiry_button element
        driver.execute_script("arguments[0].scrollIntoView({ behavior: 'smooth', block: 'center' });", Container_Inquiry_button)
        time.sleep(2)
        ...
        Tracking_ID_Details_button = driver.find_element(By.XPATH, '//a[@href="#detailView"]')
        Tracking_ID_Details_button.click()
        time.sleep(2)
